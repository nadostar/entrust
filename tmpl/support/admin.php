        ...
        <div class="col-lg-12">
           <div class="ibox">
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-6">
                            <button class="new-form btn btn-primary" data-toggle="tooltip" data-placement="left" title="Refresh inbox"><i class="fa fa-edit"></i> New Admin User</button>
                        </div>
                        <form id="search-form">
                        <div class="col-lg-6">
...
var urls = {
    'search': "<?php url('support/admin/?m=search', true, false); ?>",
    'viewer': "<?php url('support/admin/?m=viewer', true, false); ?>",
    'saveChanges': "<?php url('support/admin/?m=saveChanges', true, false); ?>",
    'initPassword': "<?php url('support/admin/?m=initPassword', true, false); ?>",
};
...
$(function(){
    ...
    $('body')
        ...
        .on('click', "button.init-password", function(){
            var $button = $(this);
            ...
            console.log(urls['initPassword'], params);

            swal({
              title: "Are you sure?",
              text: "Initialization password",
              type: "info",
              showCancelButton: true,
              closeOnConfirm: false,
              showLoaderOnConfirm: true,
            ...
            function(){
                $.post(urls['initPassword'], params).done(function(response){
                    console.log(response);
