    ...
    <div class="mail-box">
        <table class="table table-hover table-mail ">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="partner btn btn-warning btn-circle btn-outline" data-id="<?php es($row['pid']); ?>" data-placement="top" title="Partners"><i class="fa fa-users"></i></button>
                    <!--
                    <?php if($row['type'] == 1): ?>
