    ...
    <div class="mail-box">
        <table class="table table-hover table-mail ">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="accesskey btn btn-plain btn-xs" data-id="<?php es($row['id']); ?>" <?php if($row['accesskey'] > 0) es("disabled"); ?>><i class="fa fa-retweet"></i> AccessKey</button>
                    <button type="button" class="download btn btn-plain btn-xs" data-id="<?php es($row['id']); ?>" <?php if($row['accesskey'] == 0) es("disabled"); ?>><i class="fa fa-download"></i> Download</button>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php else: ?>
