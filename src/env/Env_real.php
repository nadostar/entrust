...
class Env {
    ...
    const RECEIVE_URL = "http://47.91.170.199/api/receive/?rs={receive}&esid={1}";
    ...
    private static $database_config = array(
        'system' => array(
            ...
            'param'         => array(
                'host'      => 'rm-j6canh50u5621c35l.mysql.rds.aliyuncs.com',
                'port'      => '3306',
                'user'      => 'entrust',
                'password'  => 'xingli00!',
    ...
    private static $log_config = array(
    	...
    	'file_debug' => array(
    		...
    		'level'     => 2,
    		'param'     => array(
    			'file'           => '/home/irteamsu/logs/debug.log',
    			'single_line'    => true
    		)
    	),
        'file_warn' => array(
            ...
            'level'     => 4,
            'param'     => array(
                'file'           => '/home/irteamsu/logs/warn.log',
                'single_line'    => true
            )
        ),
        'file_error' => array(
            ...
            'level'         => 5,
            'param'         => array(
                'file'      	=> '/home/irteamsu/logs/error.log',
                'buffer'    	=> false,
            )
        ),
    );
